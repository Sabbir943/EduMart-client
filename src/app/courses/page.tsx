              ...
              courses.map((course) => (
                ...
                >
                  ...
                  <div className="relative h-44 w-full bg-gray-100 overflow-hidden shrink-0 border-b border-gray-100">
                    ...
                    <span className={`absolute top-3 right-3 px-2 py-0.5 rounded text-[10px] font-extrabold tracking-wider uppercase shadow-sm ${
                  ...
                  <div className="p-4 flex flex-col flex-1 justify-between bg-white">
                    ...
                    <div className="flex items-center justify-between pt-2 border-t border-gray-100 mt-1">
                      ...
                      <button className="px-3.5 py-2 bg-indigo-600 hover:bg-indigo-700 text-white font-bold text-xs rounded-xl transition-all flex items-center gap-1.5 shadow-md shadow-indigo-600/10 active:scale-95">
      ...
      {!loading && totalPages > 1 && (
        <div className="flex items-center justify-center gap-5 pt-4 relative z-10">
          <button
            ...
            disabled={page === 1}
            className="p-2 bg-slate-900 border border-slate-800 hover:border-slate-700 disabled:opacity-30 rounded-xl text-slate-300 transition-colors flex items-center gap-1 text-xs font-bold shadow-lg"
          >
